...
\
For CRNA, we need to edit the **rn-cli.config.js** file (You can create one if it isn't present)
...
If all went well, in your console you should see a wallet object and a mnemonic.